...
def carregar_dados():
    try:
        ...
        # Garantir que estamos trabalhando com uma Series 1-dimensional
        close_series = dados['Close'].squeeze()  # Remove dimensões extras
        
        # Criar DataFrame corretamente com índice explícito
        df = pd.DataFrame({
